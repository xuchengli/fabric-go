...
export default class FabricGoView {
  ...
  constructor(serializedState) {
    ...
    **/
    ...
    identityInsetPanelHeader.innerHTML = 'Fabric Identities';
    ...
    this.identityList = document.createElement('ul');
    this.identityList.classList.add('list-group');
    identityInsetPanelBody.appendChild(this.identityList);
  ...
  setIdentitiesHandler() {
    ...
    this.identities.forEach(identity => {
      const { name, type, attributes } = identity;
      const identityItem = document.createElement('li');
      identityItem.classList.add('list-item');
      this.identityList.appendChild(identityItem);

      const identityItemText = document.createElement('span');
      identityItemText.classList.add('icon', 'icon-person');
      identityItemText.innerHTML = name;
      identityItem.appendChild(identityItemText);
    });
  }
