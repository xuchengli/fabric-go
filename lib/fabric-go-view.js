  ...
  setChainCodesHandler() {
    ...
    this.chaincodes.forEach(chaincode => {
      ...
      chaincodeItemInstallButton.addEventListener('click', () => {
        ...
        if (this.chaincodeStatus !== 'started') {
          alert('Please build and start chaincode first.');
          return;
        }
        ...
        this.fabricNetwork.exec('cli', cmd, (err, msg) => {
          ...
          this.logConsoleBody2.innerHTML += msg;
          this.logTab2.click();
          this.chaincodeStatus = 'installed';
        });
      });
