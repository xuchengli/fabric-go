      ...
      if (!this.chaincodeMap[chaincode]) {
        ...
        chaincodeItemBuildButton.addEventListener('click', () => {
          ...
          this.fabricNetwork.exec('chaincode', cmd, (err, msg) => {
            ...
            if (this.chaincodeMap[chaincode]) {
              ...
              this.chaincodeMap[chaincode]['dom']['log-console-1'].scrollTop = this.chaincodeMap[chaincode]['dom']['log-body-1'].scrollHeight;
            }
        ...
        chaincodeItemInstallButton.addEventListener('click', () => {
          ...
          this.fabricNetwork.exec('peer', `rm -rf /var/hyperledger/production/chaincodes/${chaincode}.0`, (err, msg) => {
            ...
            // 再安装当前的链码
            const cmd = `peer chaincode install -p chaincodedev/chaincode/${chaincode} -n ${chaincode} -v 0`;
            this.fabricNetwork.exec('cli', cmd, (err, msg) => {
              ...
              this.chaincodeMap[chaincode]['dom']['log-console-2'].scrollTop = this.chaincodeMap[chaincode]['dom']['log-body-2'].scrollHeight;
          ...
          const modalPanel = atom.workspace.addModalPanel({
            item: new CCParamModal(
              ...
              params => {
                ...
                const cmd = `peer chaincode instantiate -n ${chaincode} -v 0 -c '{"Args":${JSON.stringify(params)}}' -C myc`;
                this.fabricNetwork.exec('cli', cmd, (err, msg) => {
                  if (err) {
                    chaincodeItemInstantiateButton.innerHTML = 'Instantiate';
          ...
          const modalPanel = atom.workspace.addModalPanel({
            item: new CCParamModal(
              ...
              params => {
                ...
                const cmd = `peer chaincode invoke -n ${chaincode} -c '{"Args":${JSON.stringify(params)}}' -C myc`;
                this.fabricNetwork.exec('cli', cmd, (err, msg) => {
                  if (err) {
                    chaincodeItemInvokeButton.innerHTML = 'Invoke';
          ...
          const modalPanel = atom.workspace.addModalPanel({
            item: new CCParamModal(
              ...
              params => {
                ...
                const cmd = `peer chaincode query -n ${chaincode} -c '{"Args":${JSON.stringify(params)}}' -C myc`;
                this.fabricNetwork.exec('cli', cmd, (err, msg) => {
                  if (err) {
                    chaincodeItemQueryButton.innerHTML = 'Query';
        ...
        const logConsoleBody1 = document.createElement('span');
        ...
        const logConsoleBody2 = document.createElement('span');
